...
struct Rect {
  ...
  INDEX Width() {
    return rc_iRight - rc_iLeft;
  }

  INDEX Height() {
    return rc_iBottom - rc_iTop;
  }
...
class ENGINE_API CTerrain : public CBrushBase {
  public:
    ...
    inline INDEX GetQuadsPerTileRow(void) {
      return tr_ctQuadsInTileRow;
    }

    inline INDEX GetVerticesPerTileRow(void) {
      return tr_ctVerticesInTileRow;
    }

    // Read terrain version
  ...
  public:
    ...
    INDEX tr_iSelectedLayer; // Selected layer in WED
