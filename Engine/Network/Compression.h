...
// Compressor for compressing memory blocks using LZ compression (uses LZRW1 - a modification by Ross Williams)
...
// Compressor for compressing memory blocks using zlib compression (zlib uses LZ77 - algorithm)
