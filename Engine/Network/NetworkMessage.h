...
class ENGINE_API CNetworkMessage {
  ...
  public:
    ...
    inline CNetworkMessage &operator>>(float &f) {
      Read(&f, sizeof(f));
      return *this;
    }
    inline CNetworkMessage &operator>>(ULONG &ul) {
      Read(&ul, sizeof(ul));
      return *this;
    }
    inline CNetworkMessage &operator>>(UWORD &uw) {
      Read(&uw, sizeof(uw));
      return *this;
    }
    inline CNetworkMessage &operator>>(UBYTE &ub) {
      Read(&ub, sizeof(ub));
      return *this;
    }
    ...
    inline CNetworkMessage &operator>>(SBYTE &sb) {
      Read(&sb, sizeof(sb));
      return *this;
    }
    inline CNetworkMessage &operator>>(MESSAGETYPE &mt) {
      Read(&mt, sizeof(mt));
      return *this;
    }
    CNetworkMessage &operator>>(CTString &str);
    // Write an object into message.
    inline CNetworkMessage &operator<<(const float &f) {
      Write(&f, sizeof(f));
      return *this;
    }
    inline CNetworkMessage &operator<<(const double &d) {
      Write(&d, sizeof(d));
      return *this;
    }
    inline CNetworkMessage &operator<<(const ULONG &ul) {
      Write(&ul, sizeof(ul));
      return *this;
    }
    inline CNetworkMessage &operator<<(const UWORD &uw) {
      Write(&uw, sizeof(uw));
      return *this;
    }
    inline CNetworkMessage &operator<<(const UBYTE &ub) {
      Write(&ub, sizeof(ub));
      return *this;
    }
    ...
    inline CNetworkMessage &operator<<(const SBYTE &sb) {
      Write(&sb, sizeof(sb));
      return *this;
    }
    inline CNetworkMessage &operator<<(const MESSAGETYPE &mt) {
      Write(&mt, sizeof(mt));
      return *this;
    }
    ...
    inline CNetworkMessage &operator>>(TICK &ll) {
      Read(&ll, sizeof(ll));
      return *this;
    } // throw char *
    inline CNetworkMessage &operator<<(const TICK &ll) {
      Write(&ll, sizeof(ll));
      return *this;
    } // throw char *
