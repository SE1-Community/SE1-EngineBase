...
// NOTE: compression type bits in the messages are different than compression type cvar values
...
// Write the block into file stream
...
#define DUMPVECTOR(v) strm.FPrintF_t(#v ":  %g,%g,%g %08x,%08x,%08x\n", (v)(1), (v)(2), (v)(3), (ULONG &)(v)(1), (ULONG &)(v)(2), (ULONG &)(v)(3))
