...
// Constructor
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions>::Vector(void) {}

// Constructor from coordinates
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions>::Vector(Type x1) {
  ASSERT(iDimensions == 1);
  (*this)(1) = x1;
}

template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions>::Vector(Type x1, Type x2) {
  ASSERT(iDimensions == 2);
  (*this)(1) = x1;
  (*this)(2) = x2;
}

template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions>::Vector(Type x1, Type x2, Type x3) {
...
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions>::Vector(Type x1, Type x2, Type x3, Type x4) {
...
template<class Type, int iDimensions> __forceinline Type Vector<Type, iDimensions>::Length(void) const {
  Type result = (Type)0;
...
// Conversion into scalar - Manhattan norm of vector
template<class Type, int iDimensions> __forceinline Type Vector<Type, iDimensions>::ManhattanNorm(void) const {
  Type result = (Type)0;
...
// Conversion into scalar - Max norm of vector
template<class Type, int iDimensions> __forceinline Type Vector<Type, iDimensions>::MaxNorm(void) const {
  Type result = (Type)0;
...
// Reference vector member by it's index (1-based indices!)
template<class Type, int iDimensions> __forceinline Type &Vector<Type, iDimensions>::operator()(int i) {
...
template<class Type, int iDimensions> __forceinline const Type &Vector<Type, iDimensions>::operator()(int i) const {
  // check boundaries (indices start at 1, not at 0)
  ASSERT(i >= 1 && i <= iDimensions);
...
// Normalize vector, i.e. make it a unit vector
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions> &Vector<Type, iDimensions>::Normalize(void) {
...
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions> &Vector<Type, iDimensions>::SafeNormalize(void) {
  Type tLen = Length();
...
// Unary minus
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions> &Vector<Type, iDimensions>::Flip(void) {
...
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions> Vector<Type, iDimensions>::operator-(void) const {
...
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions>
&Vector<Type, iDimensions>::operator*=(const Matrix<Type, iDimensions, iDimensions> &matrix2) {
  (*this) = (*this) * matrix2;
...
template<class Type, int iDimensions> __forceinline Vector<Type, iDimensions>
Vector<Type, iDimensions>::operator*(const Matrix<Type, iDimensions, iDimensions> &matrix2) const {
  ASSERT(iDimensions != 3); // 3 is optimized special case
