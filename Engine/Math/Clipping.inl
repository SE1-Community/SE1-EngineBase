...
class ENGINE_API CIntersector {
  ...
  public:
    // Constructor
    inline CIntersector(FLOAT fX0 = 0.0f, FLOAT fY0 = 0.0f) : ci_fX0(fX0), ci_fY0(fY0), ci_ct(0) {};
    ...
    inline void AddEdge(FLOAT fedgx1, FLOAT fedgy1, FLOAT fedgx2, FLOAT fedgy2);

    // Check for intersection
    inline BOOL IsIntersecting() {
      return (ci_ct % 2) != 0;
    };
};
...
// CIntersector : Checks for intersection of edge with +x axis
ENGINE_API inline void CIntersector::AddEdge(FLOAT fedgx1, FLOAT fedgy1, FLOAT fedgx2, FLOAT fedgy2) {
  ...
  if (-b / a < 0) {
    return; // no intersection, intersection coordinate x is left from 0
  }
...
inline BOOL ClipLineByNearPlane(FLOAT3D &v0, FLOAT3D &v1, FLOAT fPlaneDistance, ULONG &ulCode0, ULONG &ulCode1, ULONG ulCodeClip) {
  #if ASMOPT
  static FLOAT f1 = 1;
...
// Clip a line by a single plane - helper function
inline BOOL ClipLineByFarPlane(FLOAT3D &v0, FLOAT3D &v1, FLOAT fPlaneDistance, ULONG &ulCode0, ULONG &ulCode1, ULONG ulCodeClip) {
  #if ASMOPT
  static FLOAT f1 = 1;
  static FLOAT fDistance0, fDistance1;
