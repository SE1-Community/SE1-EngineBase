...
pl_PositionVector(vPosition), pl_OrientationAngle(aOrientation) {}
// Comparison operator.
inline BOOL CPlacement3D::operator==(const CPlacement3D &plOther) const {
  return pl_PositionVector == plOther.pl_PositionVector && pl_OrientationAngle == plOther.pl_OrientationAngle;
}
// Get the direction vector in the direction of this placement.
