...
class ENGINE_API CProjection3D {
  ...
  public:
    ...
    // Virtual function for different kinds of projections
    virtual BOOL IsPerspective(void) {
      return FALSE;
    };
    ...
    virtual void PostClip(const FLOAT3D &v3dTransformedPoint, FLOAT fTransformedR, FLOAT3D &v3dViewPoint, FLOAT &fViewR) const = 0;
...
class ENGINE_API CPerspectiveProjection3D : public CProjection3D {
  ...
  public:
    ...
    virtual void PostClip(const FLOAT3D &v3dTransformedPoint, FLOAT fTransformedR, FLOAT3D &v3dViewPoint, FLOAT &fViewR) const;
...
// CProjection3D : Reference viewer placement
...
// CProjection3D : Reference object placement
...
// CProjection3D : Reference object handle
...
// CProjection3D : Reference front clipping distance
...
// CProjection3D : Reference screen bounding box
...
// CProjection3D : Reference screen aspect ratio
...
// CProjection3D : Reference target object stretching
...
// CProjection3D : Reference view stretching
...
// CProjection3D : Reference mirror plane
...
// CProjection3D : Reference warp plane
...
// CProjection3D : Reference object face-forward flag
...
// CProjection3D : Reference corrections for depth buffer factor
...
// CPerspectiveProjection3D : Reference field of view
...
// CIsometricProjection3D : Reference zoom factor
...
// CAnyProjection3D : Initialize from a parallel projection
