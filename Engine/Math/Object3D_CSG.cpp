...
static struct CSGOperationTable csgotAddRoomsB = {
  CSGA_Remove, CSGA_WallA1, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_PortalA1A2, CSGA_Remove, CSGA_Remove,
};
...
static struct CSGOperationTable csgotAddMaterialA = {
  CSGA_WallA1, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_PortalA1A2, CSGA_Remove, CSGA_Remove, CSGA_Remove,
};
static struct CSGOperationTable csgotAddMaterialB = {
  CSGA_WallB1, CSGA_Remove, CSGA_WallB1, CSGA_Proceed, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove,
};
static struct CSGOperationTable csgotAddMaterialReverseA = {
  CSGA_WallA1, CSGA_Remove, CSGA_WallA1, CSGA_Remove, CSGA_PortalA1A2, CSGA_Remove, CSGA_Remove, CSGA_Remove,
};
static struct CSGOperationTable csgotAddMaterialReverseB = {
  CSGA_WallB1, CSGA_Remove, CSGA_Remove, CSGA_Proceed, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove,
};
...
static struct CSGOperationTable csgotSplitSectorsA = {
  CSGA_WallB1, CSGA_WallA1, CSGA_WallB1, CSGA_WallA1, CSGA_PortalB1B2, CSGA_PortalA1A2, CSGA_PortalB1B2, CSGA_PortalA1A2,
};
static struct CSGOperationTable csgotSplitSectorsB = {
  CSGA_PortalA1B1B1A1, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove,
};
...
static struct CSGOperationTable csgotJoinSectorsA = {
  CSGA_Remove, CSGA_WallA1, CSGA_WallA1, CSGA_Remove, CSGA_Remove, CSGA_PortalA1A2, CSGA_PortalA1A2, CSGA_Remove,
};
static struct CSGOperationTable csgotJoinSectorsB = {
  CSGA_Remove, CSGA_WallB1, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_PortalB1B2, CSGA_Remove, CSGA_Remove,
};
...
static struct CSGOperationTable csgotSplitPolygonsA = {
  CSGA_WallA1_2, CSGA_WallA1, CSGA_WallA1_2, CSGA_WallA1, CSGA_PortalA1A2_2, CSGA_PortalA1A2, CSGA_PortalA1A2_2, CSGA_PortalA1A2,
};
static struct CSGOperationTable csgotSplitPolygonsB = {
  CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove, CSGA_Remove,
};

/*
 * Create a new polygon that will be a piece of some split polygon.
 */
static inline CObjectPolygon *CreatePieceOfPolygon(CObjectSector *poscSector, const CObjectPolygon &opoOriginal,
                                                   BOOL bReversePlane) {
  // create new polygon
  ...
  *pomtNew = *opoOriginal.opo_Material;
  ...
  memcpy(popoPiece->opo_amdMappings, opoOriginal.opo_amdMappings, sizeof(opoOriginal.opo_amdMappings));
...
class CObjectCSG {
  public:
    ...
    inline void AddEdgeArrayAccordingToAction(CDynamicArray<DOUBLEbspedge3D> &abed, enum CSGAction csga);

    // Fill array of bsp edges from array of polygon edges.
    void PolygonEdgesToBSPEdges(CDynamicArray<CObjectPolygonEdge> &aope, CDynamicArray<DOUBLEbspedge3D> &abed);

  public:
    // Perform CSG splitting of sectors in one operand using other operand.
    void DoCSGSplitting(CObject3D &obResult, CObject3D &obA, INDEX iSectorOffsetA, struct CSGOperationTable *pcsgotA,
                        CObject3D &obB, INDEX iSectorOffsetB);
    // Perform CSG operation -- destroys both operands!
    void DoCSGOperation(CObject3D &obResult, CObject3D &obA, CObject3D &obB, struct CSGOperationTable *pcsgotA,
 ...
 * Fill array of bsp edges from array of polygon edges.
 */
void CObjectCSG::PolygonEdgesToBSPEdges(CDynamicArray<CObjectPolygonEdge> &aope, CDynamicArray<DOUBLEbspedge3D> &abed) {
  aope.Lock();
  abed.Lock();
  ...
  for (INDEX iEdge = 0; iEdge < ctEdges; iEdge++) {
    ...
    if (ope.ope_Backward) {
      ...
      abed[iEdge] = DOUBLEbspedge3D(*ope.ope_Edge->oed_Vertex1, *ope.ope_Edge->oed_Vertex0, (ULONG)ope.ope_Edge);

      // if it is not reversed
    } else {
      // add bsp edge with normal vertices
      abed[iEdge] = DOUBLEbspedge3D(*ope.ope_Edge->oed_Vertex0, *ope.ope_Edge->oed_Vertex1, (ULONG)ope.ope_Edge);
    }
  }
 ...
 * Add an entire array of BSP edges to some polygon according to action code.
 */
inline void CObjectCSG::AddEdgeArrayAccordingToAction(CDynamicArray<DOUBLEbspedge3D> &abed, enum CSGAction csga) {
  ...
  switch (csga) {
    ...
    case CSGA_PortalB1B2:
      ...
      break;
    default: ASSERTALWAYS("Unknown CSG action code");
  }
 ...
 * Perform CSG splitting of sectors in one operand using other operand.
 */
void CObjectCSG::DoCSGSplitting(CObject3D &obResult, CObject3D &obA, INDEX iSectorOffsetA, struct CSGOperationTable *pcsgotA,
                                CObject3D &obB, INDEX iSectorOffsetB) {
 ...
 * Perform CSG operation -- destroys both operands!
 */
void CObjectCSG::DoCSGOperation(CObject3D &obResult, CObject3D &obA, CObject3D &obB, struct CSGOperationTable *pcsgotA,
                                struct CSGOperationTable *pcsgotB) {
