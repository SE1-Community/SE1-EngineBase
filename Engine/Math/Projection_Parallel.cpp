...
void CParallelProjection3D::PostClip(const FLOAT3D &v3dTransformedPoint, FLOAT3D &v3dViewPoint) const {
  ...
  v3dViewPoint(1) = pr_ScreenCenter(1) + v3dTransformedPoint(1) * pr_vZoomFactors(1) + v3dTransformedPoint(3) * pr_vStepFactors(1);
  v3dViewPoint(2) = pr_ScreenCenter(2) - v3dTransformedPoint(2) * pr_vZoomFactors(2) - v3dTransformedPoint(3) * pr_vStepFactors(2);
}
