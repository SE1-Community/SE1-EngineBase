 ...
 */
void CBrushMip::ToObject3D(CObject3D &ob, CBrushSectorSelection &selbscToCopy) {
 ...
 * Fill a 3d object from a selection in a brush mip.
 */
void CBrushMip::ToObject3D(CObject3D &ob, CBrushSectorSelectionForCSG &selbscToCopy) {
...
void CBrushSector::ToObjectSector(CObjectSector &osc) {
  ...
  for (INDEX iPolygon = 0; iPolygon < ctPolygons; iPolygon++) {
    ...
    memcpy(pubUserData + sizePolygonProperties + 0 * sizeTextureProperties, &bpo.bpo_abptTextures[0].bpt_auProperties,
           sizeTextureProperties);
    memcpy(pubUserData + sizePolygonProperties + 1 * sizeTextureProperties, &bpo.bpo_abptTextures[1].bpt_auProperties,
           sizeTextureProperties);
    memcpy(pubUserData + sizePolygonProperties + 2 * sizeTextureProperties, &bpo.bpo_abptTextures[2].bpt_auProperties,
           sizeTextureProperties);
