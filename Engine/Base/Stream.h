...
class ENGINE_API CTStream {
  ...
  public:
    ...
    inline CTStream &operator>>(BOOL &b) {
      Read_t(&b, sizeof(b));
      return *this;
    } // throw char *
    // Write an object into stream.
    inline CTStream &operator<<(const float &f) {
      Write_t(&f, sizeof(f));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const double &d) {
      Write_t(&d, sizeof(d));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const ULONG &ul) {
      Write_t(&ul, sizeof(ul));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const UWORD &uw) {
      Write_t(&uw, sizeof(uw));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const UBYTE &ub) {
      Write_t(&ub, sizeof(ub));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const SLONG &sl) {
      Write_t(&sl, sizeof(sl));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const SWORD &sw) {
      Write_t(&sw, sizeof(sw));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const SBYTE &sb) {
      Write_t(&sb, sizeof(sb));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const BOOL &b) {
      Write_t(&b, sizeof(b));
      return *this;
    } // throw char *

    // [Cecil] New timer: Ticks
    inline CTStream &operator>>(TICK &ll) {
      Read_t(&ll, sizeof(ll));
      return *this;
    } // throw char *
    inline CTStream &operator<<(const TICK &ll) {
      Write_t(&ll, sizeof(ll));
      return *this;
    } // throw char *
