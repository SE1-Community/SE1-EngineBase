...
LONG WINAPI MSJExceptionHandler::MSJUnhandledExceptionFilter(PEXCEPTION_POINTERS pExceptionInfo) {
  m_hReportFile = CreateFileA(m_szLogFileName, GENERIC_WRITE, 0, 0, OPEN_ALWAYS, FILE_FLAG_WRITE_THROUGH, 0);
...
#define EXCEPTION(x) \
  ...
  FormatMessageA(FORMAT_MESSAGE_IGNORE_INSERTS | FORMAT_MESSAGE_FROM_HMODULE, GetModuleHandleA("NTDLL.DLL"), dwCode, 0, szBuffer,
                 sizeof(szBuffer), 0);
...
// == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == ==
BOOL MSJExceptionHandler::GetLogicalAddress(PVOID addr, char* szModule, DWORD len, DWORD& section, DWORD& offset) {
