...
ENGINE_API void ReadTranslationTable_t(CDynamicArray<CTranslationPair> &atpPairs, const CTFileName &fnmTable) {
  _iLine = 0;
...
ENGINE_API void AddTranslationTable_t(const CTFileName &fnmTable) {
  // just read it to global array
  ReadTranslationTable_t(_atpPairs, fnmTable);
}

// Add several tables from a directory using wildcards
ENGINE_API void AddTranslationTablesDir_t(const CTFileName &fnmDir, const CTFileName &fnmPattern) {
