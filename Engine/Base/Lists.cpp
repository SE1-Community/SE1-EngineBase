...
// CListHead : Initialize a list head
...
// CListHead : Check if list head is valid
...
// CListHead : Check if list is empty
BOOL CListHead::IsEmpty(void) const {
  ASSERT(IsValid());
  return (lh_Head == (CListNode *)&lh_NULL);
}

// CListHead : Add a node to head of list
...
// CListHead : Add a node to tail of list
...
// CListHead : Remove a node from head of list
void CListHead::RemHead(void) {
  ASSERT(!IsEmpty());
  lh_Head->Remove();
}

// CListHead : Remove a node from tail of list
void CListHead::RemTail(void) {
  ASSERT(!IsEmpty());
  lh_Tail->Remove();
}

// CListHead : Remove all elements from list
...
// CListHead : Move all elements of another list into this one
...
// CListHead :  Return the number of elements in list
...
// CListNode : Check if list node is valid
...
// CListNode : Check is linked in some list
BOOL CListNode::IsLinked(void) const {
  ASSERT(IsValid());
  return ln_Pred != NULL;
}

// CListNode : Remove a node from list
...
// CListNode : Add a node after this node
...
// CListNode : Add a node before this node
...
// CListNode :  Find the head of the list that this node is in
