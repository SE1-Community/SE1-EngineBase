...
class ENGINE_API CEntity {
  ...
  public:
    ...
    void InflictDirectDamage(CEntity *penToDamage, CEntity *penInflictor, enum DamageType dmtType, FLOAT fDamageAmmount,
                             const FLOAT3D &vHitPoint, const FLOAT3D &vDirection);
    // Apply some damage to all entities in some range (this tests for obstacles).
    void InflictRangeDamage(CEntity *penInflictor, enum DamageType dmtType, FLOAT fDamageAmmount, const FLOAT3D &vCenter,
                            FLOAT fHotSpotRange, FLOAT fFallOffRange);
    // Apply some damage to all entities in a box (this doesn't test for obstacles).
    void InflictBoxDamage(CEntity *penInflictor, enum DamageType dmtType, FLOAT fDamageAmmount, const FLOATaabbox3D &box);
  ...
  public:
    ...
    virtual void ReceiveDamage(CEntity *penInflictor, enum DamageType dmtType, FLOAT fDamageAmmount, const FLOAT3D &vHitPoint,
