...
template<class Type, int iDimensions> class BSPPolygon : public Plane<Type, iDimensions> {
  public:
    ...
    inline BSPPolygon(Plane<Type, iDimensions> &plPlane, CDynamicArray<BSPEdge<Type, iDimensions>> abedPolygonEdges,
                      ULONG ulPlaneTag) :
 ...
 */
template<class Type, int iDimensions> class BSPNode : public Plane<Type, iDimensions> { // split plane
  public:
  ...
  public:
    ...
    void FindLineMinMax(BSPLine<Type, iDimensions> &bl, const Vector<Type, iDimensions> &v0, const Vector<Type, iDimensions> &v1,
                        Type t0, Type t1);
