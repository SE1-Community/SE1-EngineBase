 ...
 */
template<class Type, int iDimensions> inline void BSPPolygon<Type, iDimensions>::AddEdge(const Vector<Type, iDimensions> &vPoint0,
                                                                                         const Vector<Type, iDimensions> &vPoint1,
                                                                                         ULONG ulTag) {
...
BOOL BSPCutter<Type, iDimensions>::SplitPolygon(BSPPolygon<Type, iDimensions> &bpoPolygon,
  ...
  Vector<Type, iDimensions> vSplitDirection
    = ((Vector<Type, iDimensions> &)plSplitPlane) * (Vector<Type, iDimensions> &)bpoPolygon;
...
template<class Type, int iDimensions> void BSPTree<Type, iDimensions>::FindLineMinMax(const Vector<Type, iDimensions> &v0,
...
template<class Type, int iDimensions> void BSPTree<Type, iDimensions>::Read_t(CTStream &strm) // throw char *
{
  // free eventual existing tree
  Destroy();
...
template<class Type, int iDimensions> void BSPTree<Type, iDimensions>::Write_t(CTStream &strm) // throw char *
{
