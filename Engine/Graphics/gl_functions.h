...
DLLFUNCTION(OGL, void, glClearColor, (GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha), 0, 0);

DLLFUNCTION(OGL, void, glClear, (GLbitfield mask), 0, 0);

DLLFUNCTION(OGL, void, glIndexMask, (GLuint mask), 0, 0);

DLLFUNCTION(OGL, void, glColorMask, (GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha), 0, 0);
...
DLLFUNCTION(OGL, void, glScissor, (GLint x, GLint y, GLsizei width, GLsizei height), 0, 0);
...
DLLFUNCTION(OGL, void, glClearAccum, (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha), 0, 0);
...
DLLFUNCTION(OGL, void, glOrtho,
            (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near_val, GLdouble far_val), 0, 0);

DLLFUNCTION(OGL, void, glFrustum,
            (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near_val, GLdouble far_val), 0, 0);

DLLFUNCTION(OGL, void, glViewport, (GLint x, GLint y, GLsizei width, GLsizei height), 0, 0);
...
DLLFUNCTION(OGL, void, glRotated, (GLdouble angle, GLdouble x, GLdouble y, GLdouble z), 0, 0);
DLLFUNCTION(OGL, void, glRotatef, (GLfloat angle, GLfloat x, GLfloat y, GLfloat z), 0, 0);
...
DLLFUNCTION(OGL, void, glCallLists, (GLsizei n, GLenum type, const GLvoid *lists), 0, 0);
...
DLLFUNCTION(OGL, void, glColor4b, (GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha), 0, 0);
DLLFUNCTION(OGL, void, glColor4d, (GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha), 0, 0);
DLLFUNCTION(OGL, void, glColor4f, (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha), 0, 0);
DLLFUNCTION(OGL, void, glColor4i, (GLint red, GLint green, GLint blue, GLint alpha), 0, 0);
DLLFUNCTION(OGL, void, glColor4s, (GLshort red, GLshort green, GLshort blue, GLshort alpha), 0, 0);
DLLFUNCTION(OGL, void, glColor4ub, (GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha), 0, 0);
DLLFUNCTION(OGL, void, glColor4ui, (GLuint red, GLuint green, GLuint blue, GLuint alpha), 0, 0);
DLLFUNCTION(OGL, void, glColor4us, (GLushort red, GLushort green, GLushort blue, GLushort alpha), 0, 0);
...
DLLFUNCTION(OGL, void, glVertexPointer, (GLint size, GLenum type, GLsizei stride, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glNormalPointer, (GLenum type, GLsizei stride, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glColorPointer, (GLint size, GLenum type, GLsizei stride, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glIndexPointer, (GLenum type, GLsizei stride, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glTexCoordPointer, (GLint size, GLenum type, GLsizei stride, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glEdgeFlagPointer, (GLsizei stride, const GLboolean *ptr), 0, 0);

DLLFUNCTION(OGL, void, glGetPointerv, (GLenum pname, void **params), 0, 0);

DLLFUNCTION(OGL, void, glArrayElement, (GLint i), 0, 0);

DLLFUNCTION(OGL, void, glDrawArrays, (GLenum mode, GLint first, GLsizei count), 0, 0);

DLLFUNCTION(OGL, void, glDrawElements, (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices), 0, 0);

DLLFUNCTION(OGL, void, glInterleavedArrays, (GLenum format, GLsizei stride, const GLvoid *pointer), 0, 0);
...
DLLFUNCTION(OGL, void, glLightfv, (GLenum light, GLenum pname, const GLfloat *params), 0, 0);
DLLFUNCTION(OGL, void, glLightiv, (GLenum light, GLenum pname, const GLint *params), 0, 0);

DLLFUNCTION(OGL, void, glGetLightfv, (GLenum light, GLenum pname, GLfloat *params), 0, 0);
DLLFUNCTION(OGL, void, glGetLightiv, (GLenum light, GLenum pname, GLint *params), 0, 0);
...
DLLFUNCTION(OGL, void, glPixelMapfv, (GLenum map, GLint mapsize, const GLfloat *values), 0, 0);
DLLFUNCTION(OGL, void, glPixelMapuiv, (GLenum map, GLint mapsize, const GLuint *values), 0, 0);
DLLFUNCTION(OGL, void, glPixelMapusv, (GLenum map, GLint mapsize, const GLushort *values), 0, 0);
...
DLLFUNCTION(OGL, void, glBitmap,
            (GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap), 0,
            0);

DLLFUNCTION(OGL, void, glReadPixels,
            (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels), 0, 0);

DLLFUNCTION(OGL, void, glDrawPixels, (GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels), 0, 0);

DLLFUNCTION(OGL, void, glCopyPixels, (GLint x, GLint y, GLsizei width, GLsizei height, GLenum type), 0, 0);
...
DLLFUNCTION(OGL, void, glTexParameterfv, (GLenum target, GLenum pname, const GLfloat *params), 0, 0);
DLLFUNCTION(OGL, void, glTexParameteriv, (GLenum target, GLenum pname, const GLint *params), 0, 0);

DLLFUNCTION(OGL, void, glGetTexParameterfv, (GLenum target, GLenum pname, GLfloat *params), 0, 0);
DLLFUNCTION(OGL, void, glGetTexParameteriv, (GLenum target, GLenum pname, GLint *params), 0, 0);

DLLFUNCTION(OGL, void, glGetTexLevelParameterfv, (GLenum target, GLint level, GLenum pname, GLfloat *params), 0, 0);
DLLFUNCTION(OGL, void, glGetTexLevelParameteriv, (GLenum target, GLint level, GLenum pname, GLint *params), 0, 0);

DLLFUNCTION(OGL, void, glTexImage1D,
            (GLenum target, GLint level, GLint internalFormat, GLsizei width, GLint border, GLenum format, GLenum type,
             const GLvoid *pixels),
            0, 0);

DLLFUNCTION(OGL, void, glTexImage2D,
            (GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLint border, GLenum format,
             GLenum type, const GLvoid *pixels),
            0, 0);

DLLFUNCTION(OGL, void, glGetTexImage, (GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels), 0, 0);
...
DLLFUNCTION(OGL, void, glPrioritizeTextures, (GLsizei n, const GLuint *textures, const GLclampf *priorities), 0, 0);

DLLFUNCTION(OGL, GLboolean, glAreTexturesResident, (GLsizei n, const GLuint *textures, GLboolean *residences), 0, 0);

DLLFUNCTION(OGL, GLboolean, glIsTexture, (GLuint texture), 0, 0);

DLLFUNCTION(OGL, void, glTexSubImage1D,
            (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels), 0, 0);

DLLFUNCTION(OGL, void, glTexSubImage2D,
            (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type,
             const GLvoid *pixels),
            0, 0);

DLLFUNCTION(OGL, void, glCopyTexImage1D,
            (GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border), 0, 0);

DLLFUNCTION(OGL, void, glCopyTexImage2D,
            (GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border), 0,
            0);

DLLFUNCTION(OGL, void, glCopyTexSubImage1D, (GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width), 0, 0);

DLLFUNCTION(OGL, void, glCopyTexSubImage2D,
            (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height), 0, 0);

/*
 * Evaluators
 */

DLLFUNCTION(OGL, void, glMap1d, (GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points), 0,
            0);
DLLFUNCTION(OGL, void, glMap1f, (GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points), 0, 0);

DLLFUNCTION(OGL, void, glMap2d,
...
DLLFUNCTION(OGL, void, glMapGrid2d, (GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2), 0, 0);
DLLFUNCTION(OGL, void, glMapGrid2f, (GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2), 0, 0);
...
// GL_EXT_blend_color
DLLFUNCTION(OGL, void, glBlendColorEXT, (GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha), 0, 0);
...
DLLFUNCTION(OGL, void, glVertexPointerEXT, (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glNormalPointerEXT, (GLenum type, GLsizei stride, GLsizei count, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glColorPointerEXT, (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glIndexPointerEXT, (GLenum type, GLsizei stride, GLsizei count, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glTexCoordPointerEXT, (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *ptr), 0, 0);

DLLFUNCTION(OGL, void, glEdgeFlagPointerEXT, (GLsizei stride, GLsizei count, const GLboolean *ptr), 0, 0);

DLLFUNCTION(OGL, void, glGetPointervEXT, (GLenum pname, void **params), 0, 0);

DLLFUNCTION(OGL, void, glArrayElementEXT, (GLint i), 0, 0);

DLLFUNCTION(OGL, void, glDrawArraysEXT, (GLenum mode, GLint first, GLsizei count), 0, 0);

// GL_EXT_texture_object

DLLFUNCTION(OGL, void, glGenTexturesEXT, (GLsizei n, GLuint *textures), 0, 0);

DLLFUNCTION(OGL, void, glDeleteTexturesEXT, (GLsizei n, const GLuint *textures), 0, 0);

DLLFUNCTION(OGL, void, glBindTextureEXT, (GLenum target, GLuint texture), 0, 0);

DLLFUNCTION(OGL, void, glPrioritizeTexturesEXT, (GLsizei n, const GLuint *textures, const GLclampf *priorities), 0, 0);

DLLFUNCTION(OGL, GLboolean, glAreTexturesResidentEXT, (GLsizei n, const GLuint *textures, GLboolean *residences), 0, 0);

DLLFUNCTION(OGL, GLboolean, glIsTextureEXT, (GLuint texture), 0, 0);

// GL_EXT_texture3D

DLLFUNCTION(OGL, void, glTexImage3DEXT,
            (GLenum target, GLint level, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border,
             GLenum format, GLenum type, const GLvoid *pixels),
            0, 0);

DLLFUNCTION(OGL, void, glTexSubImage3DEXT,
...
DLLFUNCTION(OGL, void, glCopyTexSubImage3DEXT,
...
DLLFUNCTION(OGL, void, glColorTableEXT,
            (GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *table), 0, 0);

DLLFUNCTION(OGL, void, glColorSubTableEXT,
            (GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const GLvoid *data), 0, 0);

DLLFUNCTION(OGL, void, glGetColorTableEXT, (GLenum target, GLenum format, GLenum type, GLvoid *table), 0, 0);

DLLFUNCTION(OGL, void, glGetColorTableParameterfvEXT, (GLenum target, GLenum pname, GLfloat *params), 0, 0);

DLLFUNCTION(OGL, void, glGetColorTableParameterivEXT, (GLenum target, GLenum pname, GLint *params), 0, 0);
...
DLLFUNCTION(OGL, void, glMultiTexCoordPointerSGIS,
            (GLenum target, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer), 0, 0);
...
DLLFUNCTION(OGL, void, glPointParameterfvEXT, (GLenum pname, const GLfloat *params), 0, 0);

// 1.2 functions
DLLFUNCTION(OGL, void, glDrawRangeElements,
            (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices), 0, 0);

DLLFUNCTION(OGL, void, glTexImage3D,
            (GLenum target, GLint level, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border,
             GLenum format, GLenum type, const GLvoid *pixels),
            0, 0);

DLLFUNCTION(OGL, void, glTexSubImage3D,
            (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
             GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels),
            0, 0);

DLLFUNCTION(OGL, void, glCopyTexSubImage3D,
            (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width,
             GLsizei height),
            0, 0);
