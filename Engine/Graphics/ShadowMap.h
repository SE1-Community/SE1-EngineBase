...
class ENGINE_API CShadowMap {
  public:
    ...
    inline virtual BOOL IsShadowFlat(COLOR &colFlat) {
      return FALSE;
    };
  ...
  public:
    ...
    // Return whether the shadowmap is flat or not
    inline BOOL IsFlat(void) {
      return ((sm_pulCachedShadowMap == &sm_colFlat) && (sm_pulDynamicShadowMap == NULL || (sm_ulFlags & SMF_DYNAMICBLACK)));
    };
};
